...
class EpubToAudiobook:
    def __init__(
        ...
        self.debug = debug
        audioname = output_filename if output_filename else self.bookname
        self.output_filename = audioname + ".m4b"
        self.chapters = []
...
def main():
    ...
    parser.add_argument(
        "--audioname",
        type=str,
        help="name of output media file without extension",
    )
    ...
    mybook = EpubToAudiobook(
        ...
        output_filename=args.audioname,
    )
